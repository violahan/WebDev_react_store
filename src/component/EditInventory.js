                ...
                <form onSubmit={this.submit}>
                    <div className="field">
                        <div className="control">
                            ...
                            <textarea className="textarea" name={"name"} value={this.state.name}
                    ...
                    <div className={"field"}>
                        <div className="control">
                            ...
                            <input type="text" className={"input"} name={"tags"} value={this.state.tags}
                                   onChange={this.handleChange}/>
                        </div>
                    </div>
                    <div className={"field"}>
                        <div className="control">
                            ...
                            <input type="text" className={"input"} name={"image"} value={this.state.image}
                                   onChange={this.handleChange}/>
                        </div>
                    </div>
                    <div className={"field"}>
